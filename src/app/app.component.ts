...
export class AppComponent {
  ...
  products= this.productsSource

  toggleNoStock() {
    this.showNoStockShirts = !this.showNoStockShirts
    this.products = 
      (this.showNoStockShirts) 
       ? this.productsSource
       : this.productsSource.filter((product: Product)=> product.stock > 0)
  }
}
